...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isVisible ? "translate-y-0" : "-translate-y-full"} ${isContactPage ? "bg-brand-surface border-b border-brand-primary/10 py-2" : (isScrolled ? "bg-brand-bg/95 backdrop-blur-xl border-b border-brand-primary/10 py-2" : "bg-transparent py-4")}`}>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="bg-brand-surface p-12 md:p-20 border border-brand-primary/20 relative rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="text-center mb-16">
            <h3 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight uppercase tracking-tighter">
              <span className="text-brand-primary">CLAREZA E CONTROLE</span>
            </h3>
            <p className="text-2xl text-brand-text/80 font-medium max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-12 mb-16">
            {analysisItems.map((item, index) => (
              ...
              >
                <p className="text-sm md:text-xl font-bold uppercase tracking-widest text-brand-primary/90 mb-2 text-center h-16 md:h-20 flex items-center justify-center">
                  {item.alt}
                </p>
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <ArrowDown className="text-brand-primary mb-4 w-5 h-5 md:w-6 md:h-6" />
                </motion.div>
